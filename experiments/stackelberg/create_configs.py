...
#'logistics98-robustness', 'no-mystery-robustness', 'rovers-robustness', 'tpp-robustness', 'transport-opt11-strips-robustness', 'visitall-opt14-strips-robustness', 'sokoban-opt11-strips-robustness','logistics98-robustness-driving', 'no-mystery-robustness-driving'
# 'no-mystery-robustness-driving-fuel'
# 'pipesworld-notankage-robustness'
# 'rovers-robustness-driving'
# 'sokoban-opt11-strips-robustness-walls'
# 'tpp-robustness-driving'
# 'transport-opt11-strips-robustness-driving'
# 'transport-opt14-strips-robustness'
# 'transport-opt14-strips-robustness-driving'
# 'visitall-opt14-strips-robustness-driving'
