(define
  ...
  (:init
(allowed_to_remove emmendingen loerrach)
(allowed_to_remove emmendingen weil)
(allowed_to_remove lauchringen loerrach)
(allowed_to_remove lauchringen sexau)
(allowed_to_remove loerrach wollbach)
(allowed_to_remove schopfheim sexau)
(allowed_to_remove schopfheim waldhaus)
(allowed_to_remove sexau weil)
(allowed_to_remove waldhaus wollbach)
    (at fernseher sexau)
