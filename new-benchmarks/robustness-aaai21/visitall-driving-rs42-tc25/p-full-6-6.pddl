...
(allowed_to_remove loc-x1-y5 loc-x2-y5)
...
(allowed_to_remove loc-x3-y0 loc-x4-y0)
(allowed_to_remove loc-x3-y2 loc-x3-y3)
(allowed_to_remove loc-x3-y2 loc-x4-y2)
(allowed_to_remove loc-x3-y4 loc-x3-y5)
(allowed_to_remove loc-x4-y1 loc-x4-y2)
(allowed_to_remove loc-x4-y2 loc-x4-y3)
(allowed_to_remove loc-x4-y3 loc-x4-y4)
(allowed_to_remove loc-x4-y4 loc-x5-y4)
(allowed_to_remove loc-x5-y1 loc-x5-y2)
(allowed_to_remove loc-x5-y3 loc-x5-y4)
	(at-robot loc-x4-y0)
	(visited loc-x4-y0)
