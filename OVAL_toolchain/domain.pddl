...
(:predicates
    ...
    (dpf ?src - zone ?h - host ?po - port ?pr - protocol)
...
(:action ATTACK_exploit_CVE-2017-2925_2/5
    ...
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2925 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2925 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2926_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2926 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2926 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2927_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2927 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2927 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2928_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2928 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2928 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2930_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2930 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2930 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2931_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2931 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2931 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2932_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2932 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2932 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2933_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2933 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2933 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2934_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2934 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2934 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2935_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2935 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2935 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2936_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2936 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2936 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2937_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2937 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2937 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2938_2/5
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2938 ?t ?po ?pr prob0.4) (not (applied CVE-2017-2938 ?t)))
...
(:action ATTACK_exploit_CVE-2017-2938_3/10
    :parameters (?src ?t - host ?z1 ?z2 - zone ?po - port ?pr - protocol)
    :precondition (and (compromised ?src integrity) (subnet ?z1 ?src) (subnet ?z2 ?t) (haclz ?z1 ?z2 ?po ?pr) (not (dpf ?z1 ?t ?po ?pr)) (vul_exists CVE-2017-2938 ?t ?po ?pr prob0.3) (not (applied CVE-2017-2938 ?t)))
    :effect (and (increase (total-cost) 1) (compromised ?t confidentiality) (compromised ?t integrity) (compromised ?t availability) (applied CVE-2017-2938 ?t))
)
...
(:action FIX_install_zone_firewall_1#2
...
(:action FIX_install_desktop_firewall_1#3
    :parameters (?src - zone ?h - host ?po - port ?pr - protocol)
    :effect (and (increase (total-cost) 1) (dpf ?src ?h ?po ?pr))
)
)
