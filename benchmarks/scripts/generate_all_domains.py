...
domains_array = ["logistics", "rovers", "tpp", "transport", "visitall", "nomystery", "logistics-driving", "nomystery-driving", "rovers-driving", "tpp-driving", "transport-driving", "visitall-driving"]
