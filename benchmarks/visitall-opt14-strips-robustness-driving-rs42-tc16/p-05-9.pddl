...
(allowed_to_remove loc-x0-y7 loc-x1-y7)
(allowed_to_remove loc-x3-y1 loc-x4-y1)
(allowed_to_remove loc-x3-y4 loc-x4-y4)
(allowed_to_remove loc-x4-y2 loc-x5-y2)
(allowed_to_remove loc-x4-y4 loc-x4-y5)
(allowed_to_remove loc-x5-y2 loc-x6-y2)
(allowed_to_remove loc-x5-y6 loc-x6-y6)
(allowed_to_remove loc-x6-y0 loc-x7-y0)
(allowed_to_remove loc-x6-y6 loc-x6-y7)
(allowed_to_remove loc-x7-y2 loc-x7-y3)
(allowed_to_remove loc-x8-y3 loc-x8-y4)
(allowed_to_remove loc-x8-y7 loc-x8-y8)
	(at-robot loc-x4-y4)
	(visited loc-x4-y4)
