...
(:init
    ...
    (has_OS_version host0 3)
    (has_service host0 IIS4)
    (has_service_version host0 IIS4 3)

    (has_OS host1 winNT4_ser)
    (has_OS_version host1 1)
    (has_service host1 IIS4)
    (has_service_version host1 IIS4 1)

    (has_OS host2 winNT4_ser)
    (has_OS_version host2 2)
    (has_service host2 IIS4)
    (has_service_version host2 IIS4 2)

    (has_OS host3 winNT4_ent)
    (has_OS_version host3 1)
    (has_service host3 SQL4)
    (has_service_version host3 SQL4 1)

    (has_OS host4 win2000_ser)
    (has_OS_version host4 1)
    (has_service host4 MSRPC5)
    (has_service_version host4 MSRPC5 1)

    (has_OS host5 win2000_adv)
    (has_OS_version host5 2)
    (has_service host5 IIS5)
    (has_service_version host5 IIS5 2)

    (has_OS host6 winNT4_ser)
    (has_OS_version host6 1)
    (has_service host6 SQL4)
    (has_service_version host6 SQL4 1)

    (has_OS host7 win2000_adv)
    (has_OS_version host7 1)
    (has_service host7 MSRPC5)
    (has_service_version host7 MSRPC5 1)

    (has_OS host8 win2000_adv)
    (has_OS_version host8 1)
    (has_service host8 IIS5)
    (has_service_version host8 IIS5 1)

    (has_OS host9 winNT4_ent)
    (has_OS_version host9 2)
    (has_service host9 SQL4)
    (has_service_version host9 SQL4 2)
)
(:goal (and
    (controlling host1)
    (controlling host8)
