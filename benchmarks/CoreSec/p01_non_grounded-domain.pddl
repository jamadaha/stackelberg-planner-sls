...
(:action ATTACK_ex-host0_winNT4ser_IIS4_vuln7_17/100
...
(:action ATTACK_ex-host1_winNT4ser_IIS4_vuln0_47/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host2_winNT4ser_IIS4_vuln15_73/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host3_winNT4ent_SQL4_vuln60_69/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host4_win2000ser_MSRPC5_vuln23_64/100
    :parameters (?src - host ?t - host)
    :precondition (and (hacl ?src ?t p445) (controlling ?src) (has_OS ?t win2000_ser) (has_service ?t MSRPC5))
    :effect (and (increase (total-cost) 3) (and (controlling ?t)))
)

(:action ATTACK_ex-host5_win2000adv_IIS5_vuln25_71/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host6_winNT4ser_SQL4_vuln15_84/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host7_win2000adv_MSRPC5_vuln61_74/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host8_win2000adv_IIS5_vuln89_82/100
    :parameters (?src - host ?t - host)
...
(:action ATTACK_ex-host9_winNT4ent_SQL4_vuln24_82/100
    :parameters (?src - host ?t - host)
