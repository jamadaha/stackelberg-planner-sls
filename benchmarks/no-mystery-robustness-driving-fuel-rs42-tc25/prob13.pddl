...
(allowed_to_remove breisach denzlingen)
...
(allowed_to_remove endingen tumringen)
(allowed_to_remove endingen wittlingen)
...
(allowed_to_remove kleinkems riedlingen)
(allowed_to_remove lauchringen schopfheim)
(allowed_to_remove lauchringen tumringen)
