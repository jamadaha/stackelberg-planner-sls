...
(allowed_to_remove bahlingen waldhaus)
(allowed_to_remove breisach koendringen)
(allowed_to_remove breisach loerrach)
(allowed_to_remove breisach muellheim)
(allowed_to_remove breisach sexau)
(allowed_to_remove brombach freiburg)
(allowed_to_remove brombach waldhaus)
(allowed_to_remove denzlingen tumringen)
(allowed_to_remove denzlingen waldkirch)
(allowed_to_remove freiburg koendringen)
(allowed_to_remove guendlingen lauchringen)
(allowed_to_remove guendlingen loerrach)
(allowed_to_remove haltingen kleinkems)
(allowed_to_remove haltingen tumringen)
(allowed_to_remove haltingen waldkirch)
(allowed_to_remove kleinkems schallstadt)
(allowed_to_remove lauchringen waldhaus)
(allowed_to_remove muellheim sexau)
(allowed_to_remove schallstadt weil)
(allowed_to_remove tumringen waldhaus)
(allowed_to_remove waldkirch weil)
