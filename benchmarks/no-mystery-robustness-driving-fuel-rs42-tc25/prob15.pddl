...
(allowed_to_remove bad-bellingen haltingen)
(allowed_to_remove bahlingen koendringen)
(allowed_to_remove bahlingen weil)
(allowed_to_remove boetzingen schopfheim)
(allowed_to_remove boetzingen wollbach)
(allowed_to_remove denzlingen hugstetten)
(allowed_to_remove emmendingen haltingen)
(allowed_to_remove emmendingen hugstetten)
(allowed_to_remove freiburg schallstadt)
(allowed_to_remove freiburg weil)
(allowed_to_remove guendlingen tumringen)
(allowed_to_remove guendlingen weil)
(allowed_to_remove kleinkems schopfheim)
(allowed_to_remove kleinkems tumringen)
