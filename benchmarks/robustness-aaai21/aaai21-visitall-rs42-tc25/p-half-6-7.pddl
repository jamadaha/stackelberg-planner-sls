...
(allowed_to_remove loc-x0-y3 loc-x1-y3)
(allowed_to_remove loc-x0-y5 loc-x1-y5)
(allowed_to_remove loc-x0-y6 loc-x1-y6)
(allowed_to_remove loc-x1-y0 loc-x1-y1)
(allowed_to_remove loc-x1-y1 loc-x1-y2)
(allowed_to_remove loc-x1-y1 loc-x2-y1)
(allowed_to_remove loc-x1-y2 loc-x2-y2)
(allowed_to_remove loc-x2-y0 loc-x2-y1)
(allowed_to_remove loc-x2-y2 loc-x2-y3)
(allowed_to_remove loc-x2-y2 loc-x3-y2)
(allowed_to_remove loc-x2-y4 loc-x2-y5)
...
(allowed_to_remove loc-x3-y5 loc-x3-y6)
(allowed_to_remove loc-x4-y2 loc-x5-y2)
(allowed_to_remove loc-x4-y3 loc-x5-y3)
(allowed_to_remove loc-x4-y4 loc-x5-y4)
(allowed_to_remove loc-x5-y0 loc-x5-y1)
