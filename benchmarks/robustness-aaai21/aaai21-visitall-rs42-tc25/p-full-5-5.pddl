...
(:init
(allowed_to_remove loc-x0-y0 loc-x0-y1)
(allowed_to_remove loc-x0-y1 loc-x0-y2)
(allowed_to_remove loc-x0-y2 loc-x1-y2)
(allowed_to_remove loc-x0-y3 loc-x0-y4)
(allowed_to_remove loc-x0-y4 loc-x1-y4)
(allowed_to_remove loc-x1-y0 loc-x2-y0)
(allowed_to_remove loc-x1-y2 loc-x1-y3)
(allowed_to_remove loc-x1-y2 loc-x2-y2)
(allowed_to_remove loc-x1-y3 loc-x1-y4)
(allowed_to_remove loc-x1-y3 loc-x2-y3)
(allowed_to_remove loc-x1-y4 loc-x2-y4)
(allowed_to_remove loc-x2-y2 loc-x2-y3)
(allowed_to_remove loc-x2-y2 loc-x3-y2)
(allowed_to_remove loc-x2-y3 loc-x2-y4)
(allowed_to_remove loc-x2-y3 loc-x3-y3)
(allowed_to_remove loc-x2-y4 loc-x3-y4)
(allowed_to_remove loc-x3-y0 loc-x3-y1)
(allowed_to_remove loc-x3-y1 loc-x3-y2)
(allowed_to_remove loc-x3-y1 loc-x4-y1)
(allowed_to_remove loc-x3-y2 loc-x3-y3)
(allowed_to_remove loc-x3-y2 loc-x4-y2)
(allowed_to_remove loc-x3-y3 loc-x3-y4)
(allowed_to_remove loc-x3-y4 loc-x4-y4)
(allowed_to_remove loc-x4-y2 loc-x4-y3)
(allowed_to_remove loc-x4-y3 loc-x4-y4)
	(at-robot loc-x1-y1)
	(visited loc-x1-y1)
