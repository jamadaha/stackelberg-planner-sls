...
(allowed_to_remove brombach hugstetten)
...
(allowed_to_remove freiburg waldkirch)
(allowed_to_remove gottenheim muellheim)
(allowed_to_remove gottenheim riedlingen)
(allowed_to_remove gottenheim waldhaus)
(allowed_to_remove hugstetten kandern)
(allowed_to_remove hugstetten schopfheim)
(allowed_to_remove kandern lauchringen)
(allowed_to_remove lauchringen riedlingen)
(allowed_to_remove riedlingen schopfheim)
(allowed_to_remove riedlingen waldhaus)
(allowed_to_remove schopfheim tumringen)
