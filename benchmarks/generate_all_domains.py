...
domains_array = ["logistics98-robustness", "no-mystery-robustness-driving", "rovers-robustness-driving", "sokoban-opt11-strips-robustness-walls", "tpp-robustness-driving", "transport-opt11-strips-robustness-driving", "transport-opt14-strips-robustness-driving", "visitall-opt14-strips-robustness-driving"]
