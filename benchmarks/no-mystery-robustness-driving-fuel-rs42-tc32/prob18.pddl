...
(allowed_to_remove guendlingen muellheim)
(allowed_to_remove inzlingen kandern)
(allowed_to_remove kandern sexau)
(allowed_to_remove kleinkems koendringen)
(allowed_to_remove kleinkems schopfheim)
(allowed_to_remove lauchringen sexau)
(allowed_to_remove lauchringen weil)
