...
(allowed_to_remove auggen denzlingen)
(allowed_to_remove auggen gottenheim)
(allowed_to_remove auggen kleinkems)
...
(allowed_to_remove brombach schallstadt)
...
(allowed_to_remove gottenheim koendringen)
(allowed_to_remove inzlingen kleinkems)
(allowed_to_remove inzlingen wittlingen)
(allowed_to_remove kleinkems koendringen)
(allowed_to_remove kleinkems waldhaus)
(allowed_to_remove koendringen weil)
(allowed_to_remove lauchringen merdingen)
(allowed_to_remove lauchringen schopfheim)
(allowed_to_remove lauchringen wollbach)
(allowed_to_remove merdingen schopfheim)
(allowed_to_remove merdingen wollbach)
(allowed_to_remove muellheim tumringen)
(allowed_to_remove schallstadt wollbach)
(allowed_to_remove waldkirch wittlingen)
    (at ICE koendringen)
    (at auto inzlingen)
