...
(allowed_to_remove loc-x3-y5 loc-x4-y5)
(allowed_to_remove loc-x4-y0 loc-x5-y0)
(allowed_to_remove loc-x4-y2 loc-x5-y2)
(allowed_to_remove loc-x4-y5 loc-x5-y5)
(allowed_to_remove loc-x4-y6 loc-x4-y7)
(allowed_to_remove loc-x5-y0 loc-x5-y1)
(allowed_to_remove loc-x5-y3 loc-x6-y3)
(allowed_to_remove loc-x6-y0 loc-x6-y1)
(allowed_to_remove loc-x6-y4 loc-x7-y4)
	(at-robot loc-x4-y4)
	(visited loc-x4-y4)
