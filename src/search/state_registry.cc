...
StateRegistry::StateRegistry(IntPacker *_state_packer,
                             const std::vector<int> &_initial_state_data)
...
{
    return GlobalState(state_data_pool[id.value], this, id, state_packer);
}
