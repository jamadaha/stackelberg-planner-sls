...
protected:
    ...
    void expand_all_successors(const GlobalState &state, std::vector<const GlobalOperator*> &fix_ops_sequence, int fix_actions_cost, std::vector<int> parent_attack_plan, int parent_attack_plan_cost, std::vector<int> &sleep,
