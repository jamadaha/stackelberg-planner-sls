...
void AttackSuccessProbReuseHeuristic::reinitialize(PerStateInformation<AttackSearchInfo>* per_state_information, SearchSpace* search_space, OpenList<pair<StateID, int>>* open_list, GlobalState goal_state) {
	...
	while (!open_list->empty()) {
        StateID id = open_list->remove_min(NULL).first;
