...
namespace stackelberg {
    ...
    void StackelbergSearch::initialize()
    {
        ...
        fix_operators_successor_generator.reset(create_successor_generator(
    ...
    void StackelbergSearch::sort_operators()
    {
    ...
    double StackelbergSearch::prob_cost_to_prob(int prob_cost)
    {
    ...
    void StackelbergSearch::divide_variables()
    {
    ...
    void StackelbergSearch::clean_attack_actions()
    {
    ...
    void StackelbergSearch::create_new_variable_indices()
    {
    ...
    void StackelbergSearch::adjust_var_indices_of_ops(vector<GlobalOperator> &ops, const vector<int> &map_precond_var_id_to_new_var_id, const vector<int> &map_eff_var_id_to_new_var_id)
    {
    ...
    void StackelbergSearch::check_fix_vars_attacker_preconditioned()
    {
 ...
 */
            void StackelbergSearch::compute_commutative_and_dependent_fix_ops_matrices()
            {
            ...
            void StackelbergSearch::compute_fix_facts_ops_sets()
            {
            ...
            void StackelbergSearch::prune_applicable_fix_ops_sss(const GlobalState &state,
...
void StackelbergSearch::compute_always_applicable_attack_ops(vector<GlobalOperator> &ops) {
...
string StackelbergSearch::fix_state_to_string(const GlobalState &state) {
    string res = "";
                                               ...
                                               vector<int> &sleep, bool recurse)
{
    ...
    if (!info_fix_sequence.already_in_frontier) {
        pareto_frontier.add_node(fix_actions_cost, attack_plan_cost, fix_ops_sequence, parent_attack_plan_applicable ? parent_attack_plan : attack_plan);
...
SearchStatus StackelbergSearch::step() {
    ...
    pareto_frontier.dump(attack_operators);
