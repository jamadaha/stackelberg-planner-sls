...
namespace stackelberg {
    ...
    private:
        const double attack_budget_factor;
        const double fix_budget_factor;
    
        const bool use_partial_order_reduction;
        const bool check_parent_attack_plan_applicable;
        const bool check_fix_state_already_known;
        const bool do_attack_op_dom_pruning;
        const bool use_IDS;
        //disabled: const bool sort_fix_ops_stupid;
        const bool sort_fix_ops_advanced;
        // disabled: const bool greedy_fix_search;
        ...
        std::unique_ptr<SuccessorGeneratorSwitch> fix_operators_successor_generator;
