...
(allowed_to_remove haltingen schopfheim)
(allowed_to_remove hugstetten wittlingen)
(allowed_to_remove inzlingen merdingen)
(allowed_to_remove inzlingen wittlingen)
(allowed_to_remove kandern schallstadt)
(allowed_to_remove kandern weil)
(allowed_to_remove kleinkems weil)
(allowed_to_remove schopfheim wittlingen)
    (at ICE koendringen)
