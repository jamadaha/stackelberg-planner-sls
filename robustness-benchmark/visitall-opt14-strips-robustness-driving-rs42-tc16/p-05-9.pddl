...
(allowed_to_remove loc-x0-y6 loc-x0-y7)
(allowed_to_remove loc-x1-y5 loc-x2-y5)
(allowed_to_remove loc-x1-y7 loc-x1-y8)
(allowed_to_remove loc-x1-y7 loc-x2-y7)
(allowed_to_remove loc-x2-y2 loc-x3-y2)
(allowed_to_remove loc-x3-y4 loc-x4-y4)
(allowed_to_remove loc-x4-y2 loc-x4-y3)
(allowed_to_remove loc-x4-y5 loc-x4-y6)
(allowed_to_remove loc-x4-y8 loc-x5-y8)
(allowed_to_remove loc-x5-y3 loc-x6-y3)
(allowed_to_remove loc-x5-y4 loc-x5-y5)
(allowed_to_remove loc-x5-y6 loc-x5-y7)
(allowed_to_remove loc-x6-y2 loc-x6-y3)
(allowed_to_remove loc-x7-y4 loc-x8-y4)
	(at-robot loc-x4-y4)
	(visited loc-x4-y4)
