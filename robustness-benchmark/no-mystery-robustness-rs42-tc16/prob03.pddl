...
(allowed_to_remove freiburg gottenheim)
...
(allowed_to_remove gottenheim waldkirch)
(allowed_to_remove kandern lauchringen)
(allowed_to_remove merdingen muellheim)
(allowed_to_remove muellheim waldkirch)
(allowed_to_remove riedlingen waldkirch)
