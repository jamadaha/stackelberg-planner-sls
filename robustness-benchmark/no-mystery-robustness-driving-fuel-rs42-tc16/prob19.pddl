...
(allowed_to_remove auggen loerrach)
...
(allowed_to_remove brombach merdingen)
(allowed_to_remove denzlingen tumringen)
(allowed_to_remove denzlingen waldhaus)
(allowed_to_remove endingen merdingen)
(allowed_to_remove freiburg tumringen)
(allowed_to_remove hugstetten loerrach)
(allowed_to_remove hugstetten waldhaus)
(allowed_to_remove inzlingen merdingen)
(allowed_to_remove inzlingen tumringen)
    (at ICE inzlingen)
